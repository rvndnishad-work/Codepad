...
> = {
  ...
  "empty-vue":    { Icon: SiVuedotjs,   color: "#42b883", bg: "rgba(66,184,131,0.10)" },
  "empty-angular":{ Icon: SiAngular,    color: "#dd0031", bg: "rgba(221,0,49,0.10)" },
  "empty-svelte": { Icon: SiSvelte,     color: "#ff3e00", bg: "rgba(255,62,0,0.10)" },
  "empty-solid":  { Icon: SiSolid,      color: "#2c87cb", bg: "rgba(44,135,203,0.14)" },
