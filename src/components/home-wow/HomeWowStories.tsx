        ...
        <WowReveal>
          ...
          <div className="mt-3 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-4 md:self-end">
              ...
              <Link
                href="/blog"
                className="group flex w-fit shrink-0 items-center gap-2 rounded-full border border-border bg-panel px-6 py-3 text-xs font-black uppercase tracking-wider transition hover:border-secondary"
              >
