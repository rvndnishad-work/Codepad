 ...
 *
 * Usage: npx tsx scripts/db-check-react-ultra.mts react-augments-ultra-10.ts
 */
...
if (!file) {
  console.error("Usage: npx tsx scripts/db-check-react-ultra.mts <react-augments-ultra-NN.ts>");
  process.exit(1);
}
