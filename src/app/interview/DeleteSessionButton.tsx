  ...
  return (
    <>
      <button
        ...
        className="h-10 w-10 rounded-xl border border-border bg-bg text-muted hover:text-red-500 hover:border-red-500/50 hover:bg-red-500/5 transition-all duration-200 flex items-center justify-center shrink-0 disabled:opacity-40 hover:scale-[1.02] active:scale-[0.98]"
