  ...
  return (
    <section className="mx-auto max-w-6xl px-4 py-20">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
        ...
        {/* Quick Start Grid */}
        {QUICK_STARTS.map((q) => (
           <Link key={q.id} href={`/play?template=${q.id}`} className="md:col-span-3 rounded-2xl border border-border bg-panel/40 p-4 hover:border-accent/40 hover:bg-panel transition-all group">
              ...
              <div className="font-bold text-fg mb-1">{q.label}</div>
