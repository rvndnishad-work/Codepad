                  ...
                  <div role="tablist" aria-label="Solution framework" className="flex rounded-xl border border-border bg-surface p-1">
                    {frameworkKeys.map((fw) => (
                      <button
                        ...
                        className={`h-8 rounded-lg px-3 text-[13px] font-medium transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent motion-reduce:transition-none ${
                          fw === activeFw ? "bg-elevated text-fg shadow-[inset_0_1px_0_rgb(255_255_255/0.06)]" : "text-subtle hover:text-fg"
                        }`}
                      >
