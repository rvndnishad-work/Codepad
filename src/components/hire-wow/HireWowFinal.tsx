...
export default function HireWowFinal({ ctaHref, signedIn }: { ctaHref: string; signedIn: boolean }) {
  ...
  return (
    <section ref={root} className="wow-noise relative overflow-hidden bg-surface text-fg">
      <div aria-hidden className="pointer-events-none absolute inset-0">
        <div className="absolute left-1/2 top-[-200px] h-[420px] w-[820px] -translate-x-1/2 rounded-full bg-secondary/30 blur-[130px]" />
