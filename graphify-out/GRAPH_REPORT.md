...
## Corpus Check
- 251 files · ~153,162 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1130 nodes · 1692 edges · 69 communities (48 shown, 21 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 20 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1510c78f`
...
Cohesion: 0.08
Nodes (11): updateSchema, STATIC_ROUTES, Params, Ctx, credentialsProvider, credsSchema, { handlers, auth, signIn, signOut }, oauthProviders (+3 more)
...
Cohesion: 0.14
Nodes (14): AdminLayout(), metadata, POST(), schema, Ctx, DELETE(), Params, adminEmails() (+6 more)
...
- **Why does `isAdmin()` connect `Privacy Policy` to `Snippet Management & Actions`, `Community 34`, `Community 35`, `Home Page Sections`, `File System & Search Hooks`, `Global Layout & Provider`, `User Dashboard UI`, `Community 41`, `Next.js Configuration`, `Community 26`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `TemplateLogo()` connect `Landing Page Components` to `Core Architecture & Setup`, `Template & Icon Utilities`?**
