...
const questions: Q[] = [
  ...
  { title: "Closures in JavaScript — what and why", slug: "javascript-closures",
    description: "What is a closure? Give a practical use case.",
    answer: "A **closure** is a function bundled with references to its lexical scope, so it can access outer variables after the outer function returns. Common uses: data privacy, memoization, and event handlers capturing state.",
    company: "Google", technology: "javascript", difficulty: "easy", round: "Phone Screen", experienceLevel: "fresher", tags: ["javascript", "closures", "scope"], years: [2023] },
