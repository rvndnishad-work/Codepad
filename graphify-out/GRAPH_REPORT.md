...
## Corpus Check
- 252 files · ~153,619 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1133 nodes · 1700 edges · 71 communities (52 shown, 19 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 20 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ea774a29`
...
Cohesion: 0.05
Nodes (18): BlogListingPage(), metadata, safeTags(), Tab, TABS, AuthorFooterPost, BlogCardProps, Props (+10 more)
...
Cohesion: 0.06
Nodes (30): NotFound(), EditBlogPage(), ExplorePage(), metadata, Attempt, difficultyBg, difficultyColor, formatDuration() (+22 more)
...
Cohesion: 0.09
Nodes (8): updateSchema, Params, Ctx, credentialsProvider, credsSchema, { handlers, auth, signIn, signOut }, oauthProviders, patchSchema
...
Cohesion: 0.19
Nodes (14): applyUpdate(), DELETE(), ensureAdmin(), filesSchema, fullSchema, GET(), partialSchema, PATCH() (+6 more)
...
Cohesion: 0.17
Nodes (13): AdminLayout(), metadata, DELETE(), Params, authorise(), GET(), looksLikeEmail(), Params (+5 more)
...
Cohesion: 0.13
Nodes (6): STATIC_ROUTES, Ctx, POST(), schema, globalForPrisma, metadata
...
Cohesion: 0.21
Nodes (5): Ctx, Params, adminEmails(), isAdminEmail(), AdminUsersPageProps
...
Cohesion: 0.18
Nodes (3): JoinCodePageProps, metadata, metadata
...
- **Why does `isAdmin()` connect `Community 24` to `Community 32`, `Snippet Management & Actions`, `Home Page Sections`, `File System & Search Hooks`, `Community 38`, `Global Layout & Provider`, `Community 44`, `Next.js Configuration`, `Community 51`, `Community 25`, `Community 26`, `Community 30`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `getSignalingUrls()` connect `Community 27` to `Core Architecture & Setup`, `Community 23`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `TemplateLogo()` connect `Landing Page Components` to `Monaco Editor Integration`, `Template & Icon Utilities`?**
